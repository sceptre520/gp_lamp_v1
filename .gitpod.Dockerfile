...
RUN apt-get update && apt-get -y install apache2 mysql-server php7.4 libapache2-mod-php php-mysql php-curl php-gd php-mbstring php-xml php-xmlrpc php-intl php-bcmath php-zip
