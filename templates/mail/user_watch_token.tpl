{* $Id: user_watch_token.tpl 78611 2021-07-05 17:11:28Z jonnybradley $ *}<a href="mailto:{$email_token}">{$email_token}</a> {tr}has consulted your{/tr} {$prefs.mail_template_custom_text}
