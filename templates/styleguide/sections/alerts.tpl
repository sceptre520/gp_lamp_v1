    ...
    <div class="row">
        <div class="col-sm-8 col-md-9">
            <div class="alert alert-primary" role="alert">
                <a class="close">×</a> <strong>Primary Alert</strong>
            </div>
        </div>
        ...
        <div class="col-sm-4 col-md-3">
            <div class="input">
                <p class="picker" data-selector=".alert-primary" data-element="background-color">
                    <label for="tc-alert-primary-bg-color">Background:</label>
                ...
                <p class="picker" data-selector=".alert-primary" data-element="border-color">
                    <label for="tc-alert-primary-border-color">Border:</label>
                ...
                <p class="picker" data-selector=".alert-primary" data-element="color">
                    <label for="tc-alert-primary-text-color">Text:</label>
    ...
    <div class="row">
        <div class="col-sm-8 col-md-9">
            <div class="alert alert-secondary" role="alert">
                <a class="close">×</a> <strong>Secondary Alert</strong>
            </div>
        </div>
        ...
        <div class="col-sm-4 col-md-3">
            <div class="input">
                <p class="picker" data-selector=".alert-secondary" data-element="background-color">
                    <label for="tc-alert-secondary-bg-color">Background:</label>
                ...
                <p class="picker" data-selector=".alert-secondary" data-element="border-color">
                    <label for="tc-alert-secondary-border-color">Border:</label>
                ...
                <p class="picker" data-selector=".alert-secondary" data-element="color">
                    <label for="tc-alert-secondary-text-color">Text:</label>
    ...
    <div class="row">
        <div class="col-sm-8 col-md-9">
            <div class="alert alert-success" role="alert">
                <a class="close">×</a> <strong>Success</strong> You successfully read this important alert message.
            </div>
        </div>
        ...
        <div class="col-sm-4 col-md-3">
            <div class="input">
                <p class="picker" data-selector=".alert-success" data-element="background-color">
                    <label for="tc-alert-success-bg-color">Background:</label>
                ...
                <p class="picker" data-selector=".alert-success" data-element="border-color">
                    <label for="tc-alert-success-border-color">Border:</label>
                ...
                <p class="picker" data-selector=".alert-success" data-element="color">
                    <label for="tc-alert-success-text-color">Text:</label>
        ...
        <div class="col-sm-4 col-md-3">
            <div class="input">
                <p class="picker" data-selector=".alert-danger" data-element="background-color">
                    <label for="tc-alert-danger-bg-color">Background:</label>
                ...
                <p class="picker" data-selector=".alert-danger" data-element="border-color">
                    <label for="tc-alert-danger-border-color">Border:</label>
                ...
                <p class="picker" data-selector=".alert-danger" data-element="color">
                    <label for="tc-alert-danger-text-color">Text:</label>
        ...
        <div class="col-sm-4 col-md-3">
            <div class="input">
                <p class="picker" data-selector=".alert-warning" data-element="background-color">
                    <label for="tc-alert-warning-bg-color">Background:</label>
                ...
                <p class="picker" data-selector=".alert-warning" data-element="border-color">
                    <label for="tc-alert-warning-border-color">Border:</label>
                ...
                <p class="picker" data-selector=".alert-warning" data-element="color">
                    <label for="tc-alert-warning-text-color">Text:</label>
    ...
    <div class="row">
        <div class="col-sm-8 col-md-9">
            <div class="alert alert-info" role="alert">
                <a class="close">×</a> <strong>Information</strong> This alert needs your attention, but it's not super important.
            </div>
        </div>
        ...
        <div class="col-sm-4 col-md-3">
            <div class="input">
                <p class="picker" data-selector=".alert-info" data-element="background-color">
                    <label for="tc-alert-info-bg-color">Background:</label>
                ...
                <p class="picker" data-selector=".alert-info" data-element="border-color">
                    <label for="tc-alert-info-border-color">Border:</label>
                ...
                <p class="picker" data-selector=".alert-info" data-element="color">
                    <label for="tc-alert-info-text-color">Text:</label>
